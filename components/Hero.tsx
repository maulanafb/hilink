    ...
    return (
        <section className='max-container padding-container flex flex-col gap-20 py-10 md:gap-28 lg:py-20 xl:flex-row'>
            ...
            <div className='relative z-20 flex flex-col flex-1 xl:w-1/2' >
                ...
                <h1 className='bold-52 lg:bold-88 '>Singkawang Camp Area</h1>
                <p className='regular-16 mt-6 text-gray-50 xl:max-w-[520px]'>
                    We want to be on each journeys seeking the satisfaction of seeing the incorruptible beauty of nature.
                    we can help you on an adventure aroud the world in just one app.
                </p>
            ...
            <div className='relative flex flex-1 items-start '>
                <div className='relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8'>
                    <div className='flex flex-col'>
                        ...
                        <p className='bold-20 text-white'>Singkawang</p>
                    </div>

                    <div className='flexBetween'>
                        <div className="flex flex-col">
                            <p className='regular-16 block text-gray-20'>Distance</p>
                            <p className='bold-20 text-white'>17.2 ml</p>
                        </div>
                        <div className="flex flex-col">
