    ...
    return (
        <section className='max-container  flexCenter w-full flex-col pb-[100px] ]'>
            <div className='get-app'>
                <div className='z-20 w-full flex flex-1 flex-col items-start justify-between gap-12 pt-10'>
                    <h2 className='bold-40 lg:bold-64 xl:max-w-[320px]'>Get For Free Now!</h2>
                    <p className='regular-16 text-gray-10'>Available on iOS and Android</p>
                    <div className='flex w-full flex-col gap-3 whitespace-nowrap xl:flex-row'>
                        <Button type='button' title='App Store' icon='/apple.svg' variant='btn_white' full />
                        <Button type='button' title='Play Store' icon='/andro.svg' variant='btn_dark_green_outline' full />
                    </div>
                </div>
